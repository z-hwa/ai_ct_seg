...
def get_parser(argv):
    ...
    # train loop
    parser.add_argument("--AMP", default=None, type=str, help="whether to open amp, true or false")
    ...
    parser.add_argument("--lambda_gdl", default=0.5, type=float, help="lambda of gdl")
    parser.add_argument("--lambda_boundary", default=0.5, type=float, help="lambda of boundary")
