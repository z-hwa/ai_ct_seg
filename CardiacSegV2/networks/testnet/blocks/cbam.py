# code from https://github.com/xmu-xiaoma666/External-Attention-pytorch/blob/master/model/attention/CBAM.py
import numpy as np
import torch
...
if __name__ == '__main__':
    input=torch.randn(1,48,96,96,96)
    kernel_size=7
    cbam = CBAM(channel=48,reduction=16,kernel_size=kernel_size)
    output=cbam(input)
    print(output.shape)