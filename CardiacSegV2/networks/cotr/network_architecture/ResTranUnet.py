...
import numpy as np
from networks.cotr.network_architecture import CNNBackbone
from networks.cotr.network_architecture.neural_network import SegmentationNetwork
from networks.cotr.network_architecture.DeTrans.DeformableTrans import DeformableTransformer
from networks.cotr.network_architecture.DeTrans.position_encoding import build_position_encoding
